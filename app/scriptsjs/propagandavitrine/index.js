$(function(){
    var table = new DefaultDataTable({
        "ajax": {
            "url": $('#propagandavitrinetable').data('path'),
            "type": "POST",
            "data": function (d) {
    ...
    }, '#propagandavitrinetable', '', '', null, function () {

        $('#propagandavitrinetable').on('draw.dt', function () {
            $(".editar-grid").click(function () {
                var data = $('#propagandavitrinetable').DataTable().row($(this).parents('tr')).data();
                var _url = $('#propagandavitrinetable').data('path-edit');
            ...
            $(".ativoDeativo-grid").click(function () {
                var data = $('#propagandavitrinetable').DataTable().row($(this).parents('tr')).data();                
                var _urlDelete = $('#propagandavitrinetable').data('path-actdeact');
