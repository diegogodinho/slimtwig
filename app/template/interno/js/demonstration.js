...
function currentTime() {
    ...
    $("#calendario-topo").html(currentDate.getDate() + " de " + monthNames[currentDate.getMonth()] + " " + currentDate.getFullYear());
    $("#calendario-topo-diahora").html(dayNames[currentDate.getDay()] + ", " + currentDate.getHours() + ":" + ("0" + currentDate.getMinutes()).slice(-2));
